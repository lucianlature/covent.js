 ...
 */
function PostsController(model, view) {
    var that = this;
    that.model = model;
    that.view = view;
 ...
 */
PostsController.prototype.setView = function (locationHash) {
 ...
 * todo-list
 */
PostsController.prototype.showAll = function () {
    var that = this;
 ...
 */
PostsController.prototype.showActive = function () {
    var that = this;
 ...
 */
PostsController.prototype.showCompleted = function () {
    var that = this;
 ...
 */
PostsController.prototype.addItem = function (title) {
    var that = this;
 ...
 */
PostsController.prototype.editItem = function (id) {
    var that = this;
 ...
 */
PostsController.prototype.editItemSave = function (id, title) {
    var that = this;
    if (title.trim()) {
 ...
 */
PostsController.prototype.editItemCancel = function (id) {
    var that = this;
    that.model.read(id, function (data) {
 ...
 * storage
 */
PostsController.prototype.removeItem = function (id) {
    var that = this;
 ...
 */
PostsController.prototype.removeCompletedItems = function () {
    var that = this;
    that.model.read({ completed: true }, function (data) {
 ...
 */
PostsController.prototype.toggleComplete = function (id, completed, silent) {
    var that = this;
 ...
 */
PostsController.prototype.toggleAll = function (completed) {
    var that = this;
 ...
 * number of todos.
 */
PostsController.prototype._updateCount = function () {
    var that = this;
 ...
 */
PostsController.prototype._filter = function (force) {
 ...
 */
PostsController.prototype._updateFilterState = function (currentPage) {
